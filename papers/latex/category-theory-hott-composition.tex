...
\emph{are} identified rather than merely related. The module proves four theorems. (T1) Univalence turns Part~I's Axiom~(Equivalence) from a postulate into
...
formalization. Category theory and HoTT are therefore where the laws of composition and
identity that bind Parts~I--VI are made explicit.
\end{abstract}
...
we do \emph{not} claim a single universal functor $\Math\to\Phys$, since the
...
carry two composition laws. Their compatibility is the central
coherence of the module, because ``composition and identity'' now appears
...
We now prove the module's four main theorems. T1 and
...
This is the central result of the module: identity of structures, formalized by
...
Part~V isolates the compositional core of the representation library. Category
