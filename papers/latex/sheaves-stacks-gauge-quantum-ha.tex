...
organizing thesis: many physical quantities are not merely \emph{described by}
mathematics but are \emph{obtained as realizations} of structured mathematical
information. The program is deliberately \textbf{modular}: rather than assert a single
...
the deepest cross-module bridge in the series: gauge redundancy in physics and
